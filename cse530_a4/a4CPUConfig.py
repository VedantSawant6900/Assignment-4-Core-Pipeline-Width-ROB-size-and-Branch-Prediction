...
def createCPU(options, processes, system):
    ...
    if options.cse530_core_config=="small":
    ...
    elif options.cse530_core_config=="C1rob":
        options.cse530_issue_width = 8
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 16
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C2rob":
        options.cse530_issue_width = 8
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 32
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C3rob":
        options.cse530_issue_width = 8
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C4rob":
        options.cse530_issue_width = 8
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 128
    elif options.cse530_core_config=="C1width":
        options.cse530_issue_width = 2
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C2width":
        options.cse530_issue_width = 4
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C3width":
        options.cse530_issue_width = 6
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C4width":
        options.cse530_issue_width = 8
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C1branch":
        options.cse530_issue_width = 6
        options.branch_predictor = "multiperspective_perceptron_64KB"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C2branch":
        options.cse530_issue_width = 6
        options.branch_predictor = "tournament"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C3branch":
        options.cse530_issue_width = 6
        options.branch_predictor = "2bit"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C4branch":
        options.cse530_issue_width = 6
        options.branch_predictor = "ltage"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="C5branch":
        options.cse530_issue_width = 6
        options.branch_predictor = "loop_predictor"
        options.cse530_num_robs= 64
        a4O3CPUConfig.initializeO3CPU(options, cpu)
    elif options.cse530_core_config=="large":
        options.cse530_issue_width = 8
        options.branch_predictor = "ltage"
